...
// } from '@/ui';
// import { useRouter } from 'expo-router';
// import { useLoginMutation } from '@/redux/auth/auth-end-points';
...
//         const newPhoneNumber = user.phoneNumber.replace('+1', '');
//         try {
//           // Use the mutation hook for login
...
//         } catch (loginError) {
//           console.error('Error during login function call:', loginError);
//           Alert.alert('Login Error', 'Failed to log in, please try again.');
//         }
//       }
//     },
...
//     } catch (signInError) {
//       Alert.alert('Error', 'Failed to send verification code');
//       console.error('Error during phone sign-in:', signInError);
//     } finally {
//       setLoading(false);
//     }
//   }
...
//       Alert.alert('Error', 'Invalid code');
//       console.error(
//         'Invalid code or error in code confirmation:',
//         confirmationError
//       );
//     } finally {
//       setLoading(false);
...
//                 <View className="mt-2 px-6">
//                   <Text>
//                     If your phone number is registered with SCORES, we will send
//                     a verification code to that number for you to use in the
//                     next step.
//                   </Text>
//                 </View>
//                 <View className="mt-2 px-6">
