...
import { Modal, Card, Text, Button, Layout, Input, Select, SelectItem, Spinner } from '@ui-kitten/components';
...
export const assessmentModal = (props) => {
    ...
    const Footer = (props) => (
        <Layout {...props}>
            ...
            <Button onPress={() => createAssessment()}>
                CREATE ASSESSMENT
            </Button>
        </Layout>
    );
    ...
    const Header = (props) => (
        <Layout {...props}>
          ...
          <Text category='s1' appearance='hint'>An assessment with the following attributes will be created for the selected student.</Text>
        </Layout>
    );
                    ...
                    <Card disabled={true} header={Header} footer={Footer}>
                        <ScrollView >   
                            ...
                            <Input
                                ...
                                onChangeText={enteredAssessmentValue => setAssessmentValue(enteredAssessmentValue)}
                            />                        
                        </ScrollView>
                    </Card>
                </ScrollView>
