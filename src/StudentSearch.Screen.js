...
class StudentSearchScreen extends Component {
  ...
  render() {
    ...
    async function selectDate(date) {
      ...
      console.log("activitiesList from sudent search screen", activitiesList);
    }
        ...
        <Layout style={{ flex: 1, justifyContent: "center" }}>
          ...
          <Input
            ...
            onChangeText={(enteredValue) =>
              this.setState({ firstName: enteredValue })
            }
            size="small"
          />
          <Text>Last Name</Text>
          <Input
            ...
            onChangeText={(enteredProgramSiteValue) =>
              this.setState({ lastName: enteredProgramSiteValue })
            }
            size="small"
          />
